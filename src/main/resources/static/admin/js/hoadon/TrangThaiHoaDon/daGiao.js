...
function searchByIdDaGiao() {
    var input = document.getElementById("search-input-daGiao").value.trim().toLowerCase();
    var table = document.getElementById("user-table-DaGiao");
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        var noteCell = rows[i].getElementsByTagName("td")[6];
...
function searchByCreationDateDaGiao() {
    var inputDate = document.getElementById("search-input-date-DaGiao").value;
    var table = document.getElementById("user-table-DaGiao");
    var rows = table.getElementsByTagName("tr");
