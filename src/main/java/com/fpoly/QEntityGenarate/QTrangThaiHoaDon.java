...
public class QTrangThaiHoaDon extends EntityPathBase<TrangThaiHoaDon> {
    ...
    public QTrangThaiHoaDon(String variable) {
        this(TrangThaiHoaDon.class, forVariable(variable), INITS);
    }

    public QTrangThaiHoaDon(Path<? extends TrangThaiHoaDon> path) {
    ...
    public QTrangThaiHoaDon(PathMetadata metadata, PathInits inits) {
        this(TrangThaiHoaDon.class, metadata, inits);
    }

    public QTrangThaiHoaDon(Class<? extends TrangThaiHoaDon> type, PathMetadata metadata, PathInits inits) {
